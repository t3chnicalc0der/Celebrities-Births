...
class Scraper:
    '''
    ### Summary
    Find URL that you want to scrape, inspect the page,
    Find the data you want to extract, write the code
    ...
    def get_celebrities(self, date: str = None) -> list:
        ...
        This method gets a list of celebrities in date format
